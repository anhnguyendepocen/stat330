  \item There is only one restroom in a restaurant, where customers go to this
    ...
    \ansfont{
      ...
      \begin{enumerate}
        ...
        \item Expected waiting time in the system is $E[R]=E[X]/\lambda_A= 4/(4/5)=5$ min and expected service time is $E[S]=1/\mu=1/(1/3)=3$. Thus $E[W]=E[R]-E[S]=5-3=2$ min.
        \item $P(W>15)=(1-(4/5)e^{-5/2})=0.066$.
      \end{enumerate}
    }