\item There is only one restroom in a restaurant, where customers go to this
    ...
    \ansfont{
      ...
      \begin{enumerate}
        ...
        \item $P(X(t)=0)=\pi_0=0.2$ implies no one using the restroom 20\% of the time.
        \item $P(X(t)<3)=P(X(t)\le 2)=\pi_0+\pi_1+\pi_2=.2+.16+.128=.488$
        \item Expected response time in the system is $E[R]=E[X]/\lambda_A= 4/(4/15)=15$ min and expected service time is $E[S]=1/\mu=1/(1/3)=3$. Thus $E[W]=E[R]-E[S]=15-3=12$ min.
