...
\item Using the result in part (c), construct an approximate 95\% confidence interval for 
...
\quad
\frac{1}{n}\left[ \hat\theta_C(1 - \hat\theta_C) + \hat\theta_T(1-\hat\theta_T) + \hat\theta_C\hat\theta_T \right]
\]
\[ \begin{array}{l}
\hat{\theta}_C - \hat{\theta}_T \pm z_{a/2} \sqrt{\frac{1}{n}\left[ \hat\theta_C(1 - \hat\theta_C) + \hat\theta_T(1-\hat\theta_T) + \hat\theta_C\hat\theta_T \right]} \\
=
0.44 - 0.41 \pm 1.96 \sqrt{\frac{1}{800}\left[ 0.44(1-0.44)+0.41(1-0.41)+0.44\cdot 0.41 \right]} \\
= 
% se = sqrt((0.44*(1-0.44)+0.41*(1-0.41)+0.44*0.41)/800)
