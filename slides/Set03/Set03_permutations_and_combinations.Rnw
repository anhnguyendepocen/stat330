...
\begin{frame}
\frametitle{Second chip is defective}

Suppose an individual draws two chips and we want to know the probability the second chip is defective.
