...
Thus a $100(1-a)$\% confidence interval for $\mu_X-\mu_Y$ is
\[ 
\overline{x} - \overline{y} \pm t_{a/2,n_X+n_Y-2} \, s_p \sqrt{\frac{1}{n_X} + \frac{1}{n_Y}}.
\]
...
Thus a $100(1-a)$\% confidence interval for $\mu_X-\mu_Y$ is
\[ 
\overline{x} - \overline{y} \pm t_{a/2,v} \, \sqrt{\frac{s_X^2}{n_X} + \frac{s_Y^2}{n_Y}}.
\]
...
\[ \begin{array}{llrll}
\textrm{Model} & \textrm{Parameter} & \multicolumn{3}{c}{\textrm{Confidence interval}} \\
\hline
...
Small sample: derive actually distribution (or an approximation)

\[ \begin{array}{llrll}
\textrm{Model} & \textrm{Parameter} & \multicolumn{3}{c}{\textrm{Confidence interval}} \\
\hline
X_i \ind N(\mu,\sigma^2) & \mu & \overline{X} &\pm t_{a/2,n-1} & s/\sqrt{n} \\
X_i \ind N(\mu_X,\sigma^2), \, Y_j \ind N(\mu_Y,\sigma^2) & \mu_X - \mu_Y & \overline{X} - \overline{Y} & \pm t_{a/2,n_X+n_Y-2} & s_p \sqrt{\frac{1}{n_X}+\frac{1}{n_Y}} \\
X_i \ind N(\mu_X,\sigma_X^2), \, Y_j \ind N(\mu_Y,\sigma_Y^2) & \mu_X - \mu_Y & \overline{X} - \overline{Y} & \pm t_{a/2,v}  & \sqrt{\frac{s_X^2}{n_X}+\frac{s_Y^2}{n_Y}} \\
\hline
\end{array} \]
