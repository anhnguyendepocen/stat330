...
\begin{definition}
A \alert{parallel} system consists of $k$ components $c_{1}, \ldots, c_{k}$ arranged in such a way that the system works if at least one of the $k$ components functions properly.
\end{definition}
...
\begin{definition}
A \alert{serial} system consists of $k$ components $c_{1}, \ldots, c_{k}$ arranged in such a way that the system works if an only if all of the components function properly.
\end{definition}
